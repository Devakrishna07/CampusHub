...
function Signup() {
  ...
  return (
    <div className="w-screen min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-black to-gray-900">
        <form onSubmit={handleLogin} className="flex flex-col w-[70%] backdrop-blur-md bg-white/15 border border-white/20 shadow-xl py-3 items-center justify-center rounded-xl">
        <h1 className="text-3xl font-bold text-white m-9 self-start">Signup</h1>
        ...
        <button className="bg-white w-[30%] rounded-full p-1 font-bold m-4 hover:bg-black hover:text-white hover:rounded-xl">Signup</button>
        <div className="w-[60%] flex items-center justify-start pb-5">
            <h1 className='font-bold text-white hover:text-blue-500 cursor-pointer'><a href="/login">login existing account ?</a></h1>
        </div>
        </form>
    </div>
  )
